...
Function LoadDogs(file$)
	...
	For c=1 To 50
		...
		PositionEntity Pack\ID, x,TerrainY(land,x,100,z),z
...
Function MoveDogs(obj)
	For moveall.dog = Each dog
		...
		PositionEntity moveall\ID,ex,TerrainY(land,ex,100,ez ),ez
	Next
End Function
...
Const coll_dogs = 4
EntityType land_TEX, ENTITY_LAND
...
Collisions coll_dogs, ENTITY_LAND, 2, 2
Collisions coll_dogs, coll_dogs,1,2
Collisions coll_dogs, ENTITY_CAM,1,2
Collisions ENTITY_CAM, coll_dogs,1,2
Collisions ENTITY_CAM, ENTITY_LAND, 2, 2
